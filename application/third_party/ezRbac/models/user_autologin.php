...
class User_Autologin extends CI_Model
{
	...
	{
		$this->db->select($this->_user_table_name.'.'.$this->_user_schema['employee_id']);
		...
		$this->db->join($this->_table_name, $this->_table_name.'.user_id = '.$this->_user_table_name.'.'.$this->_user_schema['employee_id']);
