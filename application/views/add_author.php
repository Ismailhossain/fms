...
<form class="formEl_b" id="form_b" action="<?php echo base_url();?>main_controller/saveAuthor" method="post" onSubmit=" return validateStandard(this)" >
    ...
    <fieldset>
        ...
        <div class="sepH_b">
            ...
            <select name="user_role_id" id="b_select">
                <?php
