...
<div class="sepH_c">
    ...
    <form action="<?php echo site_url('product_controller/delete_checkbox_product')?>" method="post" name="frmMain">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="data_table">
            ...
            <td><select name="status" id="status" onchange="upperCase(this, <?php echo $value->product_line_id ?>);">
                <option value="">Status Selected</option>
                <option value="1">Product Line</option>
                <option value="3">Finished</option>
                <option value="4">Wastage</option>
            </select> </td>
...
<script type="text/javascript" language="javascript">
    ...
    function upperCase(el,id){
        window.location="<?php echo site_url()?>product_line_controller/change_product_status_qc/"+id+"/"+el.value;
    }
